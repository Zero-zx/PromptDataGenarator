"""
Script để chuẩn bị dataset từ vietnamese_dataset cho Qwen-Image-Edit training
...
def create_toml_config(
    ...
    control_dir: str,
    cache_dir: str,
    resolution: list = [1328, 1328]
):
    """Tạo file config TOML cho Qwen-Image-Edit"""
    ...
    config_content = f"""# Dataset configuration for Qwen-Image-Edit LoRA training
...
def main():
    parser = argparse.ArgumentParser(
        description="Chuẩn bị dataset từ vietnamese_dataset cho Qwen-Image-Edit training"
    )
    parser.add_argument(
        "--dataset_dir",
        type=str,
    ...
    parser.add_argument(
        ...
        nargs=2,
        default=[1328, 1328],
        help="Resolution [width height] (default: 1328 1328)"
    )
    ...
    print(f"       --edit")
    print(f"  4. Start training with --edit flag")
